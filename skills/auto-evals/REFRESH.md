...
- Authority order is DIB(s), accepted DR(s), PCB(s), then implementation specs; lower layers do not override higher intent.
...
- Temporary validation installs must not mutate live deferral state.
...
- For any invocation with DR inputs, reload `references/dr_sources_v2_2.md`.
